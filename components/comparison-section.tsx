    ...
    <section className="py-16 lg:py-24 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {/* Current System */}
          <div className="bg-card border border-destructive/30 rounded-xl p-6 lg:p-8 transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:bg-destructive/15 hover:border-destructive/60 hover:shadow-[0_15px_40px_rgba(220,38,38,0.2)] cursor-pointer">
          ...
          {/* With H3S */}
          <div className="bg-card border border-success/30 rounded-xl p-6 lg:p-8 transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:bg-success/15 hover:border-success/60 hover:shadow-[0_15px_40px_rgba(34,197,94,0.2)] cursor-pointer">
            <div className="flex items-center gap-3 mb-6">
